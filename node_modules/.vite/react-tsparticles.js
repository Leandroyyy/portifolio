...
var init_InteractionManager = __esm({
  "node_modules/tsparticles/esm/Core/Utils/InteractionManager.js"() {
    ...
    InteractionManager = class {
      ...
      init() {
        const interactors2 = Plugins.getInteractors(this.container, true);
...
var plugins, interactorsInitializers, updatersInitializers, interactors, updaters, presets, drawers, pathGenerators, Plugins;
var init_Plugins = __esm({
  "node_modules/tsparticles/esm/Core/Utils/Plugins.js"() {
    plugins = [];
    interactorsInitializers = new Map();
    updatersInitializers = new Map();
    interactors = new Map();
    updaters = new Map();
    presets = new Map();
    drawers = new Map();
...
var __classPrivateFieldGet, _Options_instances, _Options_findDefaultTheme, Options;
...
var __classPrivateFieldSet, __classPrivateFieldGet2, _Engine_initialized, Engine;
var init_engine = __esm({
  "node_modules/tsparticles/esm/engine.js"() {
    ...
    Engine = class {
      ...
      init() {
        if (!__classPrivateFieldGet2(this, _Engine_initialized, "f")) {
...
var __classPrivateFieldSet2, __classPrivateFieldGet3, _EmitterInstance_firstSpawn, _EmitterInstance_startParticlesAdded, EmitterInstance;
  ...
  "node_modules/tsparticles/esm/Plugins/Emitters/EmitterInstance.js"() {
    ...
    EmitterInstance = class {
      constructor(emitters, container, options, position) {
        ...
        __classPrivateFieldSet2(this, _EmitterInstance_firstSpawn, !this.options.life.wait, "f");
        __classPrivateFieldSet2(this, _EmitterInstance_startParticlesAdded, false, "f");
      ...
      play() {
        ...
        if (this.container.retina.reduceFactor && (this.lifeCount > 0 || this.immortal || !this.options.life.count) && (__classPrivateFieldGet3(this, _EmitterInstance_firstSpawn, "f") || this.currentSpawnDelay >= ((_a = this.spawnDelay) !== null && _a !== void 0 ? _a : 0))) {
      ...
      update(delta) {
        ...
        if (__classPrivateFieldGet3(this, _EmitterInstance_firstSpawn, "f")) {
          __classPrivateFieldSet2(this, _EmitterInstance_firstSpawn, false, "f");
          this.currentSpawnDelay = (_a = this.spawnDelay) !== null && _a !== void 0 ? _a : 0;
          this.currentEmitDelay = (_b = this.emitDelay) !== null && _b !== void 0 ? _b : 0;
        }
        if (!__classPrivateFieldGet3(this, _EmitterInstance_startParticlesAdded, "f")) {
          __classPrivateFieldSet2(this, _EmitterInstance_startParticlesAdded, true, "f");
...
// node_modules/tsparticles/esm/Plugins/Emitters/EmittersMain.js
var init_EmittersMain = __esm({
  "node_modules/tsparticles/esm/Plugins/Emitters/EmittersMain.js"() {
  }
});
...
var __classPrivateFieldSet3, __classPrivateFieldGet4, _ImageDrawer_images, ImageDrawer;
  ...
  "node_modules/tsparticles/esm/Shapes/Image/ImageDrawer.js"() {
    ...
    ImageDrawer = class {
      constructor() {
        ...
        __classPrivateFieldSet3(this, _ImageDrawer_images, [], "f");
      }
      getSidesCount() {
        return 12;
      }
      getImages(container) {
        const containerImages = __classPrivateFieldGet4(this, _ImageDrawer_images, "f").find((t) => t.id === container.id);
        if (!containerImages) {
          __classPrivateFieldGet4(this, _ImageDrawer_images, "f").push({
            id: container.id,
            images: []
          });
